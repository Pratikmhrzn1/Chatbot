  ...
  return (
    <Box width={"100%"} height={"100%"} display={"flex"} flex={1}>
      <Box padding={8} mt={2} display={{md:"flex",sm:"none",xs:"none"}}>
        <img src="robot.png" alt="Robot" style={{width:"450px"}}/>
        </Box>
      <Box display={"flex"} flex={{xs:1, md:0.5}} justifyContent={"center"} 
      alignItems={"center"} padding={2} ml={"auto"} mt={6} marginLeft={30}>
        <form onSubmit={handleSubmit} style={{margin:"auto", padding:"30px",
           boxShadow:"10px 10px 20px #000", borderRadius:"10px", border:"none", width:"100%", maxWidth:"400px"}}>
          <Box sx={{display:"flex", flexDirection:"column", justifyContent:"center"}}>
            ...
            <Button type="submit" sx={{px:2,py:1,mt:2,width:"400px", borderRadius:2,bgcolor:"#00fffc", ":hover":{
              bgcolor:'white',
              color:"black"
            }}} endIcon={<IoIosLogIn/>}>Sign Up</Button>
            </Box>
        </form>
      </Box>
    </Box>
